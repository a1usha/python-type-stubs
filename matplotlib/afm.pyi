...
class AFM(object):
    def __init__(self: AFM, fh: {__iter__}) -> None: ...

    def get_bbox_char(self: AFM, c: Any, isord: bool = False) -> Any: ...

    def string_width_height(self: AFM, s: {__len__, __iter__}) -> Union[
        tuple[int, int], tuple[int, Union[int, float]]]: ...

    def get_str_bbox_and_descent(self: AFM, s: {__len__, __iter__}) -> Union[
        tuple[int, int, int, int, int], tuple[int, float, int, Union[int, float], float]]: ...

    def get_str_bbox(self: AFM, s: Any) -> tuple: ...

    def get_name_char(self: AFM, c: Any, isord: bool = False) -> Any: ...

    def get_width_char(self: AFM, c: Any, isord: bool = False) -> Any: ...

    def get_width_from_char_name(self: AFM, name: Any) -> Any: ...

    def get_height_char(self: AFM, c: Any, isord: bool = False) -> Any: ...

    def get_kern_dist(self: AFM, c1: Any, c2: Any) -> int: ...

    def get_kern_dist_from_name(self: AFM, name1: Any, name2: Any) -> int: ...
