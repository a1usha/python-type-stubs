...
stix_virtual_fonts: dict[str, Union[
    dict[str, list[Union[tuple[int, int, str, int], Any]]], list[tuple[int, int, str, int]], dict[
        str, list[tuple[int, int, str, int]]], list[Union[tuple[int, int, str, int], Any]], dict[
        str, Union[list[Union[tuple[int, int, str, int], Any]], list[tuple[int, int, str, int]]]]]]
