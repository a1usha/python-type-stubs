...
class LogitTransform(Transform):
    def __init__(self: LogitTransform, nonpositive: str = 'mask') -> Optional[Any]: ...

    def transform_non_affine(self: LogitTransform, a: {__truediv__}) -> None: ...
...
class LogTransform(Transform):
    def __init__(self: LogTransform, base: {__le__, __eq__}, nonpositive: str = 'clip') -> Any: ...

    def __str__(self: LogTransform) -> str: ...

    def transform_non_affine(self: LogTransform, a: Any) -> None: ...

    def inverted(self: LogTransform) -> InvertedLogTransform: ...


class SymmetricalLogTransform(Transform):
    def __init__(self: SymmetricalLogTransform, base: {__le__}, linthresh: {__le__},
                 linscale: {__le__, __truediv__}) -> Any: ...

    def transform_non_affine(self: SymmetricalLogTransform, a: {__getitem__}) -> float: ...

    def inverted(self: SymmetricalLogTransform) -> InvertedSymmetricalLogTransform: ...


class LogitScale(ScaleBase):
    def __init__(self: LogitScale, axis: Axis, nonpositive: str = 'mask', one_half: str = r"\frac{1}{2}",
    ...
    def limit_range_for_scale(self: LogitScale, vmin: {__le__}, vmax: {__ge__}, minpos: Any) -> tuple[
        Union[float, {__le__}], Union[int, float, {__ge__}]]: ...


class FuncScale(ScaleBase):
    def __init__(self: FuncScale, axis: Any, functions: tuple[Any, Any]) -> None: ...
...
class LogScale(ScaleBase):
    ...
    def __init__(self: LogScale, axis: Any, , **kwargs) -> None: ...
    ...
    def limit_range_for_scale(self: LogScale, vmin: {__le__}, vmax: {__le__}, minpos: Any) -> tuple[
        Union[float, {__le__}], Union[float, {__le__}]]: ...
...
class SymmetricalLogScale(ScaleBase):
    ...
    def __init__(self: SymmetricalLogScale, axis: Any, , **kwargs) -> None: ...
...
class LogisticTransform(Transform):
    def __init__(self: LogisticTransform, nonpositive: str = 'mask') -> Optional[Any]: ...

    def transform_non_affine(self: LogisticTransform, a: {__neg__}) -> float: ...
...
class FuncScaleLog(LogScale):
    def __init__(self: FuncScaleLog, axis: Axis, functions: tuple[Any, Any], base: float = 10) -> None: ...
...
class InvertedSymmetricalLogTransform(Transform):
    def __init__(self: InvertedSymmetricalLogTransform, base: {__le__}, linthresh: {__le__},
                 linscale: {__le__, __truediv__}) -> None: ...

    def transform_non_affine(self: InvertedSymmetricalLogTransform, a: {__getitem__}) -> Any: ...

    def inverted(self: InvertedSymmetricalLogTransform) -> SymmetricalLogTransform: ...


class FuncTransform(Transform):
    def __init__(self: FuncTransform, forward: Callable, inverse: Callable) -> Any: ...

    def transform_non_affine(self: FuncTransform, values: Union[ndarray, Iterable, int, float]) -> Any: ...

    def inverted(self: FuncTransform) -> FuncTransform: ...


class ScaleBase(object):
    def __init__(self: ScaleBase, axis: Any) -> None: ...

    def get_transform(self: ScaleBase) -> Any: ...

    def set_default_locators_and_formatters(self: ScaleBase, axis: Any) -> Any: ...

    def limit_range_for_scale(self: ScaleBase, vmin: Any, vmax: Any, minpos: Any) -> tuple[Any, Any]: ...


class LinearScale(ScaleBase):
    def __init__(self: LinearScale, axis: Any) -> None: ...
...
class InvertedLogTransform(Transform):
    def __init__(self: InvertedLogTransform, base: Any) -> None: ...

    def __str__(self: InvertedLogTransform) -> str: ...

    def transform_non_affine(self: InvertedLogTransform, a: Any) -> None: ...
...
def scale_factory(scale: Any, axis: Axis, , **kwargs) -> Union[
