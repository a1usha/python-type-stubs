...
def _gist_heat_red(x: Any) -> float: ...
...
def _ch_helper(gamma: Any, s: {__truediv__}, r: {__mul__}, h: {__mul__}, p0: {__mul__}, p1: {__mul__},
               x: {__pow__}) -> float: ...
...
def _g31(x: Any) -> float: ...


def _g30(x: {__truediv__}) -> float: ...
...
def _gist_yarg(x: Any) -> int: ...


def _g10(x: {__mul__}) -> None: ...


def cubehelix(gamma: float = 1.0, s: float = 0.5, r: float = -1.5, h: float = 1.0) -> dict[str, partial[float]]: ...


def _g12(x: Any) -> Any: ...


def _gist_heat_green(x: Any) -> int: ...
