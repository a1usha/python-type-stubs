...
class Transform(TransformNode):
    ...
    def contains_branch_seperately(self: Transform,
                                   other_transform: {depth}) -> list[bool]: ...
...
class IdentityTransform(Affine2DBase):
    ...
    def transform(self: IdentityTransform,
                  points: Union[Union[ndarray, Iterable, int, float], Any]) -> Any: ...
...
class BlendedGenericTransform(_BlendedMixin, Transform):
    ...
    def transform_non_affine(self: BlendedGenericTransform,
                             points: Any) -> Union[Union[MaskedArray, ndarray], Any]: ...
...
class BlendedAffine2D(_BlendedMixin, Affine2DBase):
    ...
    def get_matrix(self: BlendedAffine2D) -> Union[ndarray, Any]: ...
